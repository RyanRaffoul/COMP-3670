// Assignment 3: Job Creator Thread
// Ryan Raffoul
// JobCreatorServerThread.java
// This class simply connects to a Job Seeker and communicates with it to complete the task and terminate the connection
import java.io.*;
import java.util.*;
import java.net.*;
